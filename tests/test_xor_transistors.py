...
SKIP_LAYERS = {
    (63, 0),  # TEXT labels — not generated by pure GDSFactory
    (8, 2),  # Metal1pin — port markers, not physical geometry
    (5, 2),  # GatPolypin — port markers, not physical geometry
    (10, 2),  # Metal2pin — port markers, not physical geometry
}
